...
# ==============================
    ...
    if eds_bytes is None or final_layout is None:
        ...
        # 3. TÁBLÁZAT MEGJELENÍTÉSE KIJELÖLHETŐ SOROKKAL
        ...
        # 4. GÖRBE MEGJELENÍTÉSE A TÁBLÁZAT ALATT (VAGY MELLETT)
        # Ha a felhasználó kijelölt egy sort a táblázatban
        if selection and selection["selection"]["rows"]:
            selected_row_index = selection["selection"]["rows"][0]
            selected_well = df_filtered.iloc[selected_row_index]["well_position"]
